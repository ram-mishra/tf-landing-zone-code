...
$envFiles = @("main.tf", "variables.tf", "terraform.tfvars", "provider.tf", "output.tf")
...
$modules = @(
    ...
    "appgateway-module", "frontdoor-module", "nsg-module", "storage-module"
)

# List of Terraform files to create in each module (excluding terraform.tfvars and provider.tf)
